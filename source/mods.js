/* mods.js  
Features that can be modified by a user includes profiles, Custom Trainer Cards for VIP users, and League Cards.
As all other "source" files commands are included in the chat-plugins folder.
*/
exports.profile = {
